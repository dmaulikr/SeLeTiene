...
#import "../Offer/OfferProViewController.h"
#import "../Offer/OfferSerViewController.h"

#define SegueIdentifierFirst @"goProduct"
#define SegueIdentifierSecond @"goService"

@interface ContainerViewOffer ()

@property (strong, nonatomic) NSString *currentSegueIdentifier;
@property (strong, nonatomic) OfferProViewController *firstViewController;
@property (strong, nonatomic) OfferSerViewController *secondViewController;
@property (assign, nonatomic) BOOL transitionInProgress;

@end

@implementation ContainerViewOffer
